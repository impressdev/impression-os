...
media, stat), five composites (card, list-item, form-field, nav-item, accordion),
and the component specification schema are in place. Each component is authored as data,
